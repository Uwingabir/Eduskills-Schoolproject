    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 max-w-3xl mx-auto">
          <h1 className="text-2xl font-bold mb-6 text-center">Local Study Loan Application</h1>
            ...
            <div className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input id="yearOfStudy" placeholder="E.g., First year" className="mt-1" />
                </div>
                <div>
                  <Label htmlFor="expectedGraduation">Expected Graduation Date</Label>
                  <Input id="expectedGraduation" type="date" className="mt-1" />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input id="loanAmount" placeholder="Enter amount in $" className="mt-1" />
                </div>
                <div>
                  <Label htmlFor="loanPurpose">Loan Purpose</Label>
                  <Input id="loanPurpose" placeholder="E.g., Tuition fees" className="mt-1" />
                </div>
              </div>
...
export default LocalLoanApplication;
